...
const Recipes = () => {
    ...
    const [message, setMessage] = useState("Type any dish name into the search bar to find a delicious and up-to-date recipe.");
  ...
  return (
    <div className="w-full mb-10">
          ...
          {query.length == 0 ? (
            <p className="text-center mt-5 font-medium">{message}</p>
          ) : (
            <>
              <section>
                <div className="my-10">
                  <div className="flex w-full gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        <a target="blank" href={query.strYoutube}><ViewRecipeButton>
